---
artifact_id: ART-CONSTITUTION-CODEX
...
| `approved-with-known-issues` | Human-approved artifact with documented known issues that are surfaced in every subsequent eval | Human only |
