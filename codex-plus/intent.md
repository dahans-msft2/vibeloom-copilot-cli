---
artifact_id: ART-INTENT-CODEX-PLUS
...
# Intent: Codex Plus Variant Of Contract-Driven Vibe Coding
...
Closest comparators are Tessl, Kiro Specs, and GitHub Spec Kit. This package keeps the strongest ideas from those systems while adding mandatory `USM + DM`, asymmetric reconciliation, swarm-oriented module governance, richer teaching artifacts, and more concrete implementation templates.
