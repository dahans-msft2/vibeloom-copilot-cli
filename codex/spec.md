...
# Technical Spec: Codex Methodology Package
...
3. Run structural checks on the touched slice.
...
6. Require human approval whenever the proposal changes approved semantics.
