...
- Derived from approved contract entities owned at root scope and above (none above root, so just root: intent, defaults, prd, usm, dm, system, containers in full modes; compact intent + defaults + system in vibe).
